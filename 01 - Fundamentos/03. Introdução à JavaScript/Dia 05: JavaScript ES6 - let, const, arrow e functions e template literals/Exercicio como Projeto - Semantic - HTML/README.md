...
- Use o comando: `git clone git@github.com:tryber/sd-032-a-exercise-semantic-html.git`
- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-032-a-exercise-semantic-html`
...
- Verifique que você está na raiz do projeto:
  - Exemplo: `pwd` -> o retorno vai ser algo tipo _/Users/maria/code/**sd-032-a-exercise-semantic-html**_
...
- Vá até a página de *Pull Requests* do [repositório no GitHub](https://github.com/tryber/sd-032-a-exercise-semantic-html/pulls)
...
- Volte até a [página de *Pull Requests* do repositório](https://github.com/tryber/sd-032-a-exercise-semantic-html/pulls) e confira que o seu *Pull Request* está criado
...
- Vá até a página **DO SEU** *Pull Request*, adicione a label de *'code-review'* e marque seus colegas:
  ...
  - No menu à direita, clique no *link* **'Reviewers'** e digite `students`, selecione o time `tryber/students-sd-032-a`.
