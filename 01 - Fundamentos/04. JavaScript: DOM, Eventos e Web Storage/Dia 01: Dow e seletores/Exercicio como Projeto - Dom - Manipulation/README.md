...
- Use o comando: `git clone git@github.com:tryber/sd-032-a-exercise-dom-manipulation.git`
- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-032-a-exercise-dom-manipulation`
...
- Verifique que você está na raiz do projeto:
  - Exemplo: `pwd` -> o retorno vai ser algo tipo _/Users/maria/code/**sd-032-a-exercise-dom-manipulation**_
...
- Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-032-a-exercise-dom-manipulation/pulls)
...
- Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-032-a-exercise-dom-manipulation/pulls) e confira que o seu _Pull Request_ está criado
